...
using EFEntities.Models;

namespace EFEntities.Repositories
{
    public partial class AwPersonDbContext : DbContext
    {
        public AwPersonDbContext()
            : base("name=AwPersonDbContext")
        {
        }
